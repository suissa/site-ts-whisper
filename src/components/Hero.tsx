      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/5 mb-8 animate-glow-pulse">
            ...
            <span className="text-sm font-mono text-primary">Local AI Transcription</span>
          </div>

          {/* Title */}
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold mb-6">
            <span className="text-foreground">ts-</span>
            <span className="text-primary text-glow">whisper</span>
          </h1>

          {/* Tagline */}
          <p className="text-2xl md:text-3xl font-display text-primary/80 mb-4 text-glow-sm">
            PARE DE GASTAR COM TRANSCRIÇÕES!
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-3xl">
            <div className="card-neon p-6 group">
